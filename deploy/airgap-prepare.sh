...
if [[ ! -f $K3S_BINARY ]]
then
	curl -kL -o $K3S_BINARY https://github.com/k3s-io/k3s/releases/download/v1.25.4%2Bk3s1/k3s
fi

if [[ ! -f $K3S_IMAGES_TAR ]]
then
	# Download k3s images
	curl -kL -o $K3S_IMAGES_TAR https://github.com/k3s-io/k3s/releases/download/v1.25.4%2Bk3s1/k3s-airgap-images-$ARCH.tar
fi
